...
class Hotel_Node
{
	...
	public:
		...
		void hotel_info()
		{		
			// cout << setw(20) << setfill(' ') << "Hotel Name";
		 //    cout << setw(20) << setfill(' ') << "City ";
		 //    cout << setw(5) << setfill(' ') << " Stars";
		 //    cout << setw(8) << setfill(' ') << "Price";
		 //    cout << setw(15) << setfill(' ') << "Country";
		 //    cout << setw(30) << setfill(' ') << "Address";
		 //    cout << endl;
			cout <<"========================================================================================================================================================================"<<endl;
			...
			// cout << setw(20) << setfill(' ') << this->hotel_name;
		 //    cout << setw(20) << setfill(' ') << this->city_name;
		 ...
		 //    cout << endl;
			...
			// cout << "----------------------------------------" << endl;
			// cout << "| Hotel name: " << this->get_hotel_name() << " |" << endl;
			// cout << "----------------------------------------" << endl;
			// cout << "| City: " << this->get_city_name() << " | " << endl;
			// cout << "----------------------------------------" << endl;
			// cout << "| Ranking Stars: " << this->get_stars() << " | " << endl;
			// cout << "----------------------------------------" << endl;
			// cout << "| Price: $" << this->get_price() << " | " << endl;
			// cout << "----------------------------------------" << endl;
			// cout << "| Country: " << this->get_country_name() << " |" << endl;
			// cout << "----------------------------------------" << endl;
...
int main(int argc, char *argv[])
{
	...
	// myTrie.remove("Alpine Village", "Queenstown");
	// myHotel_HashMap.remove("Alpine Village, Queenstown");
	// myHotel_HashMap.search("Alpine Village, Queenstown");
	...
	while(true)
	{
		...
		else if (query_command.substr(0,3) == "add")
		{
			...
			else
			{
				...
				//IF STATEMENT FOR CROSS CHECK 
				// CLASS and§ Function is working. But just need to figure out insertion in to the Hashtable
			}
		}
		...
		else if(query_command.substr(0,6) == "delete") 
		{
			...
			// string a = query_command.substr(7,20);
			// string b = query_command.substr(22);
